...
export function RiskDetailPanel({ forecast }: Props) {
  ...
  return (
    <aside className="sticky top-6 rounded-3xl border border-indigo-100 bg-gradient-to-br from-indigo-600 via-violet-600 to-slate-950 p-1 shadow-soft">
      <div className="rounded-[1.35rem] bg-white/95 p-6 backdrop-blur-xl">
        ...
        <div className="mt-6 rounded-2xl border border-slate-200 bg-slate-50 p-4">
          <p className="text-sm font-bold text-slate-800">왜 위험한가?</p>
        ...
        <div className="mt-5 flex flex-col gap-2 sm:flex-row">
          <button
            ...
            className="inline-flex flex-1 items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-bold text-slate-800 transition hover:border-indigo-200 hover:text-indigo-700"
          >
          ...
          <button
            ...
            className="inline-flex flex-1 items-center justify-center gap-2 rounded-xl bg-slate-950 px-4 py-3 text-sm font-bold text-white transition hover:bg-indigo-700"
          >
        ...
        {showChecklist && (
          <div className="mt-5 rounded-2xl border border-slate-200 bg-white p-4">
            <p className="text-sm font-bold text-slate-800">우선 대응 체크리스트</p>
            <ul className="mt-3 space-y-2 text-sm leading-6 text-slate-700">
              {checklist.map((item) => (
        ...
        {showNotice && (
          <div className="mt-5 rounded-2xl border border-violet-100 bg-violet-50 p-4">
            <p className="text-sm font-bold text-violet-800">주민 안내문</p>
